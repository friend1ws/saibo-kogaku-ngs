...
do 
    ...
    echo "python simpleFilt.py ../data/mapsplice/${sample}C.junctions.txt 5 > ../result/${sample}.junctions.filt.txt"
    # python simpleFilt.py ../data/mapsplice/${sample}C.junctions.txt 5 > ../result/${sample}.junctions.filt.txt
